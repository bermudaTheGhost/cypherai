...
function App() {
  return (
    <div className="container mx-auto w-full px-4 bg-black h-screen text-white">
      <header className="bg-transparent text-white w-full md:px-10">
        <img src={logo} className="h-20 text-red-600" alt="logo" />
      </header>

      <section className="relative pt-0 text-white md:pb-8 sm:py-10 sm:h-3/4 ">
        <div className="container grid md:grid-cols-3 mx-auto px-4 md:px-16">
          <div className="relative z-10 col-span-2">
            <h1 className="pt-8 text-4xl font-light leading-none md:pt-16 md:text-6xl lg:text-7.25xl xl:text-8xl">
          ...
          <div className="absolute inset-0 transform -translate-x-12 md:relative md:col-span-1 md:translate-x-0">
            <div className="absolute z-0 transform -translate-y-40 left-1/2 md:left-0 -translate-x-1/4  md:-translate-x-1/3 lg:-translate-x-96 w-full mt-[250px] md:mt-[150px] 2xl:w-[1000px] 2xl:h-[800px]  md:w-[540px] md:h-[480px] lg:w-[730px] lg:h-[610px] xl:w-[890px] xl:h-[745px]">
              <img
